...
class Box(length: Int, width: Int, height: Int) {
    ...
    init {
        ...
        // cause compiler is accessing primary constructor parameters
        // primary constructor parameters are by default constant
        // that's why it's showing error in case of re assign
        length = length
        width = width
        height = height
